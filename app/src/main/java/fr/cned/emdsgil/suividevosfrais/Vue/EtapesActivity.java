...
public class EtapesActivity extends AppCompatActivity {
    ...
    private void recupProfil() {
        ...
        if (controle.getProfil() != null) {
            if (controle.getProfil().getTable().containsKey(key)) {
                qte = controle.getProfil().getTable().get(key).getEtape() ;
            }
        } else {
    ...
    private void cmdValider_clic() {
        findViewById(R.id.cmdEtapeValider).setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                Serializer.serialize("saveProfil", controle.getProfil().getTable(), EtapesActivity.this) ;
                retourActivityPrincipale() ;
            }
        }) ;
    }
    ...
    private void enregNewQte() {
        ...
        controle.getProfil().getTable().get(key).setEtape(qte) ;
    }
